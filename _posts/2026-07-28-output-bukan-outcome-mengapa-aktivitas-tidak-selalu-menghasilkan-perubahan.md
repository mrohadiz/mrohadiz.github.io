...
Framework ini erat kaitannya dengan [Systems Thinking](/glossary/#systems-thinking) — memahami hubungan antara intervensi (output) dan perubahan sistemik (outcome). Dalam [Decision Intelligence](/glossary/#decision-intelligence), fokus pada outcome memastikan bahwa setiap keputusan dievaluasi berdasarkan perubahan nyata yang dihasilkan.
